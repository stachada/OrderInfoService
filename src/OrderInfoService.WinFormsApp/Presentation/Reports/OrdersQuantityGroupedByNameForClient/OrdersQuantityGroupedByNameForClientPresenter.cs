...
{
    public class OrdersQuantityGroupedByNameForClientPresenter : IPresenter
    {
        ...
        {
            var path = _fileDialogs.SaveFileDialog("Ilosc_zamowien_wedlug_nazwy_dla_'" + _view.SelectedClientId + "'");
